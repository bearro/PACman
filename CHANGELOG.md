...
0.1.26 -  Sun Jan 21 08:45:23 2018 +0000
    ...
    bugfix - pacvote - skip stale proposals

    style - pacvote - text edits


0.1.25 -  Sun Mar 26 05:00:38 2017 +0000

    enh - add .paccore to path in .bash_aliases on install
    enh - better block sync check
    enh - better pacd running detection
    enh - better sentinel sync messaging
    enh - pacvote 12.1 compat - background delayed sends
...
0.1.20 -  Fri Sep 2 06:49:52 2016 +0000
    ...
    bugfix - pacvote - prune completed proposals
    bugfix - follow redirects - pacninja 301->www
...
0.1.16 -  Tue Dec 29 05:41:43 2015 +0000
    ...
    bugfix - support pac.org downloads page shift to relative pathing

0.1.15 -  Thu Nov 26 02:57:45 2015 +0000

    update download url to pac.org
    bugfix - support stale nss lib - downgrade second pacninja attempt
    pacvote - monkey-patch subprocess.check_output for python <2.7
...
0.1.14 -  Sun Nov 1 03:57:56 2015 +0000
    ...
    pacvote - added git checkout info to version header
    pacvote - added loading screen, previous vote detection, vim navigation binding
    pacvote - added vote-counts, turnout percentage
    pacvote - bugfix - use alias for vote display - added threshold coloring, sort vote display by block start
    pacvote - align count/percentage columns
    pacvote - display vote hash during voting
    pacvote - ignore unmapped keystrokes
...
0.1.13 -  Sun Oct 25 05:49:37 2015 +0000
    ...
    bugfix - fail gracefully when pacninja api offline
...
0.1.12 -  Tue Oct 20 21:14:51 2015 +0000
    ...
    bugfix - status - fail gracefully if pacd not running
...
0.1.11 -  Wed Oct 14 08:19:10 2015 +0000
    ...
    bugfix - voting - fail gracefully when pac-cli not in path
...
0.1.10 -  Tue Oct 13 07:18:29 2015 +0000
    ...
    added pacd uptime calculation
    added support for hot-node (Internet server) pac.conf voting
...
0.1.9 - Sun Oct 11 04:05:54 2015 +0000
    ...
    added pacvote - time-randomized voting, initial curses UI
...
0.1.8 - Mon Sep 14 02:59:05 2015 +0000
    ...
    bugfix - die if cannot determine latest-version from/retrieve pacpay downloads page
...
0.1.6 - Tue Sep 8 07:07:57 2015 +0000
    ...
    added pacninja masternode visibility

0.1.5 - Thu Sep 10 21:34:29 2015 +0000

    added pacwhale, masternode.me polling
...
0.1.0 - Mon Sep 7 00:12:24 2015 +0000
    ...
    created new top-level script 'pacman'

    takes command line arguments:

        install
            - install latest pac executables (fresh install)
        reinstall
            - reinstall latest pac executables (overwrite existing)
        update
            - update to latest pac executables (update existing)
        sync
            - sync with github (git fetch/reset)
        restart
            - restarts (or starts) pacd
...
0.0.8 - Thu Aug 27 07:57:15 2015 +0000
    ...
    added command line switches
        ...
        -h, --help
        -v, --version
    sync_pacman_to_github.sh now pulls and sync's forced tags
