...
messages=(
    ...
    ["unzipping"]="Unzipping"
    ["waiting_for_pacd_to_respond"]="Waiting for pacd to respond..."
    ["deleting_cache_files"]="Deleting cache files, debug.log... "
    ["starting_pacd"]="Starting pacd... "
    ...
    ["err_pacman_supports"]="pacman currently only supports 32/64bit linux"
    ["err_could_not_get_version"]="Could not find latest version from"
    ["err_failed_ip_resolve"]="failed to resolve public ip. retrying... "

    ["newer_pac_available"]="a newer version of pac is available."
    ["successfully_upgraded"]="pac successfully upgraded to version"
    ...
    ["run_reinstall"]="Run 'pacman reinstall' to overwrite."
    ["reinstall_to"]="reinstall to"
    ["and_install_to"]="and install to"

    ["exec_found_in_system_dir"]="pac executables found in system dir"
    ["run_pacman_as_root"]=". Run pacman as root (sudo pacman command) to continue."
    ["pacd_not_found"]="pacd not found in"
    ["paccli_not_found"]="pac-cli not found in"
    ["paccli_not_found_in_cwd"]="cannot find pac-cli in current directory"

    ["sync_to_github"]="sync pacman to github now?"

    ["usage"]="USAGE"
    ["commands"]="COMMANDS"
    ["usage_title"]="installs, updates, and manages single-user pac daemons and wallets"
    ["usage_install_description"]="installs, updates, and manages single-user pac daemons and wallets"
    ["usage_update_description"]="updates pac to latest version and restarts (see below)"
    ["usage_restart_description"]="restarts pacd and deletes:"
    ...
    ["usage_sync_description"]="updates pacman to latest github version"
    ["usage_branch_description"]="switch pacman to an alternate/experimental github branch"
    ["usage_vote_description"]="cast masternode votes for distributed budget ballot items"
    ["usage_reinstall_description"]="overwrites pac with latest version and restarts (see below)"
    ["usage_version_description"]="prints pacmans version number and exits"
    ...
    ["requires_sync"]="Do 'pacman sync' manually, or choose yes below."
    ...
    ["status_pacdip"]="  pacd bind ip address      : "
    ["status_pacdve"]="  pacd version              : "
    ["status_uptodat"]="  pacd up-to-date           : "
    ["status_running"]="  pacd running              : "
    ["status_uptimed"]="  pacd uptime               : "
    ["status_drespon"]="  pacd responding (rpc)     : "
    ["status_dlisten"]="  pacd listening  (ip)      : "
    ["status_dconnec"]="  pacd connecting (peers)   : "
    ["status_dportop"]="  pacd port open            : "
    ["status_dconcnt"]="  pacd connection count     : "
    ["status_dblsync"]="  pacd blocks synced        : "
    ["status_dbllast"]="  last block (local pacd)   : "
    ["status_webchai"]="             (chainz)        : "
    ["status_webdark"]="             (pac.org)      : "
    ["status_webpac"]="             (pacwhale)     : "
    ["status_webmast"]="             (masternode.me) : "
    ["status_dcurdif"]="  pacd current difficulty   : "
